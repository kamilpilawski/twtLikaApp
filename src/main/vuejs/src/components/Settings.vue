<template>
  <v-dialog  v-model="$store.state.showSettings" fullscreen transition="v-dialog-bottom-transition" :overlay=false>
    <v-card>
      <v-card-row>
        <v-toolbar light>
          <v-btn icon="icon" @click.native="changeSettingsState" light>
            <v-icon>close</v-icon>
          </v-btn>
          <v-toolbar-title>Settings</v-toolbar-title>
          <v-btn light flat @click.native="changeSettingsState">Save</v-btn>
        </v-toolbar>
      </v-card-row>
